...
const KERNEL_PERSIST_SUMMARY_NOTE =
	"Note: the Bun worker keeps running after this summary — every serializable JavaScript variable and helper you defined stays available. The cells that defined them won't appear above, so record in the summary any names worth remembering so you reuse them instead of redefining them.";
