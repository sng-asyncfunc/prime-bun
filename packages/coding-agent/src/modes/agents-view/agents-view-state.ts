...
/**
 * Rewrite stale persisted row identities to their record's current canonical
 * identity. Unknown entries stay intact because their records may still be
 * streaming in from the other catalog.
 */
