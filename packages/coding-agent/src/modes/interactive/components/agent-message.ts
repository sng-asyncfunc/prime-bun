...
/** Shared summary line for received and sent agent messages. */
...
/** Single-line message preview sized to fit after the summary prefix. */
...
/** Message body lines with the same gutter used by received messages. */
